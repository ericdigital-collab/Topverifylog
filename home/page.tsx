...
export default function App() {
      ...
      <div className="min-h-screen bg-white text-gray-800 font-sans pb-16">
        ...
        <header className="border-b border-gray-100 sticky top-0 bg-white/90 backdrop-blur z-50 px-4 py-3 flex justify-between items-center">
          ...
          <button 
            ...
            className="bg-orange-500 text-white px-4 py-2 rounded-xl font-bold text-sm shadow-sm hover:bg-orange-600 transition"
          >
            Sign In
          </button>
        </header>
        ...
        <main className="px-4 pt-6 space-y-6 max-w-md mx-auto">
          ...
          <div className="flex space-x-3">
            ...
            <div className="flex-1 border border-gray-200 py-3 rounded-xl font-bold text-sm text-center text-gray-700 bg-gray-50">
              Explore Services
            </div>
          </div>

          {/* Popular Country Badges */}
          ...
          <div className="space-y-3">
            ...
            <div className="bg-white p-4 rounded-2xl border border-gray-100 shadow-sm space-y-2">
              ...
              <div className="font-bold text-gray-900 text-base">Social Media Growth</div>
              <p className="text-xs text-gray-500">Boost your Instagram, TikTok, Twitter & more organically.</p>
            </div>
          </div>
        </main>
      </div>
  ...
  // Dashboard View (Shown after clicking Sign In)
  return (
    <div className="min-h-screen bg-gray-50 text-gray-800 font-sans pb-20">
      <header className="bg-white border-b border-gray-200 sticky top-0 z-50 px-4 py-3 flex justify-between items-center shadow-sm">
        ...
        <div className="flex items-center space-x-3">
          ...
          <button onClick={() => setIsLoggedIn(false)} className="text-xs text-red-500 font-bold px-2 py-1 bg-red-50 rounded-lg">Logout</button>
        </div>
      </header>
